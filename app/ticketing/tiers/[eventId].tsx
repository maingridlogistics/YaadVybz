...
export default function TicketTiersScreen() {
  ...
  // Gate: Free (non-Pro, non-admin) users cannot access ticket tiers
        ...
        <SafeAreaView edges={['top']} style={{ backgroundColor: Colors.background }}>
          <View style={styles.header}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.headerSub}>Manage ticket types and pricing</Text>
            </View>
          </View>
        </SafeAreaView>
        <View style={styles.centered}>
          ...
          <Text style={{ fontSize: Typography.base, color: Colors.textSecondary, textAlign: 'center', lineHeight: 22, maxWidth: 300, marginTop: Spacing.sm }}>
            In-app ticket sales require Vybz Hub Pro access. Upgrade to unlock custom tiers, paid ticketing, and payout tools.
          </Text>
          <Pressable
